/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/env.generated.d.ts` (hash: 90581cdcdef1dd4470b5d54cbe5a3471)
// Runtime types generated with workerd@1.20260415.1 2026-04-01 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "DiscordGatekeeper";
	}
	interface Env {
		DB: D1Database;
		QUEUE: Queue;
		...
		CF_GROQ_KEY: string;
		CF_OPENROUTER_KEY: string;
		CF_GOOGLE_AI_KEY: string;
		GATEWAY_TOKEN: string;
		CLOUDFLARE_AI_GATEWAY: string;
		CLOUDFLARE_ACCOUNT_ID: string;
		ALLOWED_DISCORD_IDS: string;
		ALLOWED_TELEGRAM_IDS: string;
		DiscordGatekeeper: DurableObjectNamespace<import("./index").DiscordGatekeeper>;
		ARM: Fetcher /* ops-mcp-server */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DISCORD_APP_ID" | "DISCORD_BOT_TOKEN" | "DISCORD_PUBLIC_KEY" | "TELEGRAM_BOT_TOKEN" | "CF_GROQ_KEY" | "CF_OPENROUTER_KEY" | "CF_GOOGLE_AI_KEY" | "GATEWAY_TOKEN" | "CLOUDFLARE_AI_GATEWAY" | "CLOUDFLARE_ACCOUNT_ID" | "ALLOWED_DISCORD_IDS" | "ALLOWED_TELEGRAM_IDS">> {}
}
